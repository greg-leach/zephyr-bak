...
- Board features:
  ...
  - Debug
    ...
    - JTAG connector
    - MicroUSB for UART debug, two serial ports for A53 and one for M7
...
to be started by the A53 core. The A53 core is responsible for loading the M7
application into the RAM, putting the M7 in reset, setting the M7 program
counter and stack pointer, and bringing the M7 out of reset. The A53 can perform
these steps at bootloader level or after the Linux system has booted.
