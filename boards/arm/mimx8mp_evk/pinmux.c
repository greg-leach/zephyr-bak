...
static int mimx8mp_evk_pinmux_init(const struct device *dev)
{
	...
	IOMUXC_SetPinConfig(IOMUXC_I2C1_SCL_I2C1_SCL,
			    IOMUXC_SW_PAD_CTL_PAD_DSE(3U) | IOMUXC_SW_PAD_CTL_PAD_FSEL_MASK |
				    ...
				    IOMUXC_SW_PAD_CTL_PAD_HYS_MASK | IOMUXC_SW_PAD_CTL_PAD_PE_MASK);
	...
	IOMUXC_SetPinConfig(IOMUXC_ECSPI1_MISO_ECSPI1_MISO,
			    IOMUXC_SW_PAD_CTL_PAD_DSE(2U) | IOMUXC_SW_PAD_CTL_PAD_HYS_MASK);
	...
	IOMUXC_SetPinConfig(IOMUXC_GPIO1_IO09_PWM2_OUT, IOMUXC_SW_PAD_CTL_PAD_DSE(3U) |
								IOMUXC_SW_PAD_CTL_PAD_PUE_MASK |
								IOMUXC_SW_PAD_CTL_PAD_PE_MASK);
#else
	IOMUXC_SetPinMux(IOMUXC_GPIO1_IO11_PWM2_OUT, 0U);
	IOMUXC_SetPinConfig(IOMUXC_GPIO1_IO11_PWM2_OUT, IOMUXC_SW_PAD_CTL_PAD_DSE(3U) |
								IOMUXC_SW_PAD_CTL_PAD_PUE_MASK |
								IOMUXC_SW_PAD_CTL_PAD_PE_MASK);
#endif
#endif
