 ...
 *
 * @param mode (sleep, lite hibernate, or hibernate)
 ...
 * @param state is 1 when modem should stay awake, 0 when modem can sleep
 */
 ...
 * @param state follows gpio_pin_get definitions, but will default high
 * if there is an error reading pin
 */
 ...
 * @param state follows gpio_pin_get definitions, but will default low
 * if there is an error reading pin
 */
