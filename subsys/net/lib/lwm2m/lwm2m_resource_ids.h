...
#define TEMPERATURE_OBJECT_RID   3303
#define HUMIDITY_OBJECT_RID      3304
#define ACCELEROMETER_OBJECT_RID 3313
#define PRESSURE_OBJECT_RID      3323
#define DOOR_OBJECT_RID          10351
/* clang-format on */
